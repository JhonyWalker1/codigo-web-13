...
// hacer un fiulter , filtro core i3

const filtroLaptops = laptops.filter((laptop) =>
 laptop.caracteristicas.procesador==="i3");

console.log(filtroLaptops);

//forEach
//! crear un nuevo array basado en el array laptops y agregar un nueva atributo
//! llamado vendido tru o folse
